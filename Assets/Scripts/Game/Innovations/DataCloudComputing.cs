...
namespace Singularity.Game.Innovations {
    ...
    public class DataCloudComputing : Innovation {

        // Constructor
        public DataCloudComputing(Entity entity) {
        ...
        public void init() {
            ...
            unlocked = new Unlockable[] { Knowledge.CLOUD_PROGRAMMING };
        }
        ...
        override public string getName() {
            ...
            return "CLOUD COMPUTING (BIG DATA)";
