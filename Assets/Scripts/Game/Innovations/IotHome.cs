...
namespace Singularity.Game.Innovations {
    ...
    public class IotHome : Innovation {

        // Constructor
        public IotHome(Entity entity) {
        ...
        public void init() {
            ...
            unlocked = new Unlockable[] { Knowledge.WEB_3_KNOWLEDGE, entity.products.SMART_HOME_APPS, entity.products.SMART_KITCHEN, entity.products.SMART_HOME_CINEMA };
        }
